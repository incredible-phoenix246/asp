...
export const INNOVATION_SLIDES: InnovationProps[] = [
  ...
  },
  {
    ...
    description:
      'Stay ahead in a rapidly evolving digital landscape. ASpace leverages the latest technologies to ensure your project is not just current but future-proof, prodiving lasting value and adaptability.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description:
      'Quality is at the core of everything we do. ASpace is committed to delivering solutions that not only meet but exceed industry standards. Your success is our success.',
  },
];
...
export const CLIENT_SLIDES: ClientSliderProps[] = [
  {
    ...
    description:
      ' ASpace truly exceeded our expectations. Their innovative solutions and dedication to understanding our unique challenges made the collaboration seamless. We not only got a product but a transformative experience.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      'Working with ASpace was a game-changer for us. Their teams expertise and commitment to excellence were evident at every stage of the project. We are now equipped with a solution that not only meets but exceeds our business goals',
  },
  {
    id: 5,
